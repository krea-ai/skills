...
5. **Blocking still QA gate**: inspect each start-frame still with vision before animation. Reject product drift, Recolored logo, Prompt-text override, wrong claims, or generic product substitution. Do not submit video jobs until the stills pass.
