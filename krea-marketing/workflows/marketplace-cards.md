...
2. Read product references with vision and extract only visible/product-supplied facts.
...
6. QA every image for product fidelity, text legibility, unsupported claims, and marketplace-safe composition.
