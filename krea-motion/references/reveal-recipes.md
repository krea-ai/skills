...
Every recipe assumes the surrounding blocks from the `krea-generate` skill's
`../../krea-generate/references/models/seedance-2.md` are present: format, references, world, motion
