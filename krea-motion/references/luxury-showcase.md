...
Not for skincare, cosmetics or a product loop destined for a website — those want the
tonal envelope in `../references/product-beauty-macro.md`, which deliberately inverts the
tension principle below. A fragrance bottle can want either; ask which surface the
piece lives on, a campaign film or a product page.
