...
4. Inspect schema for `imageUrls` array support; prefer multi-reference support.
...
| Face changed across variants | No identity anchor | Reuse same `imageUrls` and stronger preservation prompt |
