...
- **startImage**: which keyframe file (or "extracted from S{prev}.{prev_shot} last frame")
- **endImage**: which keyframe file (or "same as next shot start" or "none" if terminal)
