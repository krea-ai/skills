...
6. Wait for completion with the available job tool, polling every 30-60 seconds using `../references/progress-reporting.md`. Training can take 15-45 minutes; run `../references/cost-preflight.md` before submitting.
