...
```text
Create a detailed vertical infographic for curious home coffee drinkers
...
Use for original, scalable identity exploration.

```text
Create four distinct logo directions for "Miller & Seed", a neighborhood
bakery focused on sourdough and seasonal pastries.

The brand should feel warm, simple, timeless, and local. Use clean
vector-like shapes, strong silhouettes, balanced negative space, and forms
that read clearly at small and large sizes.

Flat design, minimal strokes, plain background, centered mark, generous
padding. No watermark, no mockup scene, no trademarked symbols, no complex
illustration.
```
...
```text
Create a vertical comic-style reel with four equal panels.
...
```text
Create a landscape classroom diagram titled "Cellular Respiration at a Glance"
